...
Hint: The Bing Translator API is asyncronous, so when printing all five you may have some issues. The example prints all five fast, but they can all be seen on the console. Also be prepared to possibly use an array and a for loop
